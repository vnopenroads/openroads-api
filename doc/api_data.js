define({ "api": [
  {
    "type": "get",
    "url": "/admin/:id",
    "title": "Get boundaries and road data of subregions",
    "group": "Administrative_areas",
    "name": "GetAdmin",
    "description": "<p>This endpoint returns the boundaries of the subregions in the given administrative area, as well as the roads clipped to the region. The results are returned in GeoJSON.</p> ",
    "version": "0.1.0",
    "parameter": {
      "fields": {
        "Parameter": [
    ...
    "groupTitle": "Administrative_areas"
  },
  {
    "type": "get",
    "url": "/subregions/:id",
    "title": "Get list of subregions by ID",
    "group": "Administrative_areas",
    "name": "GetSubregions",
    "description": "<p>Returns meta-data about an administrative area and its  direct descendants. When passing the ID of a province, the API returns only its municipalities and cities, not the barangays.</p> ",
    "version": "0.1.0",
    "parameter": {
      "fields": {
        "Parameter": [
          {
            ...
            "optional": false,
            "field": "id",
            "description": "<p>ID of the region, province, municipality, city or  barangay.</p> "
          }
        ]
      }
    },
      ...
      "fields": {
        "Success 200": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "meta.NAME_3",
            "description": "<p>Municipality / city name.</p> "
          },
          {
            "group": "Success 200",
            "type": "String",
          ...
          },
          {
            ...
            "optional": false,
            "field": "meta.ID_3_OR",
            "description": "<p>Municipality / city ID.</p> "
          },
          {
            "group": "Success 200",
            "type": "String",
  ...
  },
  {
    ...
    "title": "Search for administrative area by name",
    "group": "Administrative_areas",
    "name": "SearchAdmin",
    "description": "<p>Given a search string, return 10 matching administrative area. Search is case insensitive.</p> ",
    "version": "0.1.0",
    "parameter": {
      "fields": {
        "Parameter": [
  ...
  },
  {
    ...
    "group": "Administrative_areas",
    "name": "subregions",
    "description": "<p>Returns a list with all the regions.</p> ",
    "version": "0.1.0",
    "success": {
      "fields": {
        "Success 200": [
