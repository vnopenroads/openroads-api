define({ "api": [
  ...
  },
  {
    ...
    "group": "Utility",
    "description": "<p>Upload OSM Changeset Data to given changeset return the changeset and a bounding box that covers the location of its  edits.</p> ",
    "parameter": {
      "fields": {
        "Parameter": [
          {
            ...
            "optional": true,
            "field": "changesetID",
            "description": "<p>Optional changeset ID</p> "
          },
          {
            "group": "Parameter",
            "type": "File",
